                          ...
                          <b-carousel id="carousel-1" :interval="4000">
                            <b-carousel-slide>
                              ...
                              <div>
                                ...
                                <p class="font-size-14 mb-0">- Kaoskastaffing User</p>
                              </div>
                            </b-carousel-slide>
              ...
              <div class="d-flex flex-column h-100">
                ...
                <div class="my-auto">
                  <div>
                    ...
                    <p class="text-muted">Get your free Kaoskastaffing account now.</p>
                  </div>
                  ...
                  <div class="mt-4">
                    <form>
                      ...
                      <div>
                        <p class="mb-0">
                          By registering you agree to the Kaoskastaffing
                ...
                <div class="mt-4 mt-md-5 text-center">
                  <p class="mb-0">
                    © {{ new Date().getFullYear() }}; Kaoskastaffing. 
                  </p>
                </div>
              </div>
            </div>
