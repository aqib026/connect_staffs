...
export default {
  ...
  methods: {
    ...
    async getResults(page = 1) {
      axios
        .get(`/api/users?page=${page}&search=${this.search}&type=worker`)
    ...
    handleMultiSubmit(e){
        ...
        axios
          .post("/api/save/multiusers?type=worker", this.inputs)
          .then(response => {
              this.showForm = false;
              this.getResults();
              this.$swal(response.data.message);
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="mb-3">
                            ...
                            <input
                              ...
                              :class="{
                                'is-invalid':
                                  submitted && $v.user.ni_number.$error,
                              }"
                            />
                            <div
                              v-if="submitted && !$v.user.ni_number.required"
                              class="invalid-feedback"
                            >
                              This value is required.
                            </div>
                        ...
                        <div class="col-6">
                          <div class="mb-3">
                            ...
                            />
                            <div
                              v-if="submitted && !$v.user.account_number.required"
                              class="invalid-feedback"
                            >
                              This value is required.
                            </div>
                        ...
                        <div class="col-6">
                          <div class="mb-3">
                            ...
                            <input
                              ...
                              :class="{
                                'is-invalid':
                                  submitted && $v.user.sort_code.$error,
                              }"
                            />
                            <div
                              v-if="submitted && !$v.user.sort_code.required"
                              class="invalid-feedback"
                            >
                              This value is required.
                            </div>
                        ...
                        <div class="col-6">
                          <div class="mb-3">
                            ...
                            <input
                              ...
                              :class="{
                                'is-invalid':
                                  submitted && $v.user.rate.$error,
                              }"
                            />
                            <div
                              v-if="submitted && !$v.user.rate.required"
                              class="invalid-feedback"
                            >
                              This value is required.
                            </div>
                        ...
                        <div class="col-6">
                          <div class="mb-3">
                            ...
                            <input
                              ...
                              :class="{
                                'is-invalid':
                                  submitted && $v.user.post_address.$error,
                              }"
                            />
                            <div
                              v-if="submitted && !$v.user.post_address.required"
                              class="invalid-feedback"
                            >
                              This value is required.
                            </div>
              ...
              <table class="table table-centered table-nowrap">
                ...
                <tbody>
                  <tr v-for="users in usersData.data" :key="users.id">
                    ...
                    <td>{{users.ni_number}}</td>
                    <td>{{users.account_number}}</td>
                    <td>{{users.sort_code}}</td>
                    <td>{{users.rate}}</td>
                    <td>{{users.post_address}}</td>
                    <td>
