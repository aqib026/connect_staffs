          ...
          <div class="card-body">
            <div class="media">
              ...
              <div class="media-body overflow-hidden">
                <h5 class="text-truncate font-size-15">Kaoskastaffing Dashboard UI</h5>
              ...
              <table class="table table-nowrap table-centered table-hover mb-0">
                <tbody>
                  <tr>
                    ...
                    <td>
                      <h5 class="font-size-14 mb-1">
                        <a href="javascript: void(0);" class="text-dark">Kaoskastaffing Landing.Zip</a>
                      </h5>
                  ...
                  <tr>
                    ...
                    <td>
                      <h5 class="font-size-14 mb-1">
                        <a href="javascript: void(0);" class="text-dark">Kaoskastaffing Admin.Zip</a>
                      </h5>
                  ...
                  <tr>
                    ...
                    <td>
                      <h5 class="font-size-14 mb-1">
                        <a href="javascript: void(0);" class="text-dark">Kaoskastaffing Logo.Zip</a>
                      </h5>
